<?php
$this->header(_('Themes'));
?>
<h1><?=_('Themes')?></h1>
<div class="esqoo-flexigrid" id="themelist"
	data-flexigrid-url="/website/theme-list/api"
	...
	data-flexigrid-col2-js-filter="esqoo_website_themes.actions"
